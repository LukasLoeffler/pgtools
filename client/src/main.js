...
import { uniFilter, uniFilterSlash, uniPlay, uniPen, uniPauseCircle, uniChannelAdd, uniLink, uniLinkBroken, uniTrashAlt } from 'vue-unicons/src/icons'
...
Unicon.add([uniFilter, uniFilterSlash, uniPlay, uniPen, uniPauseCircle, uniChannelAdd, uniLink, uniLinkBroken, uniTrashAlt ])
Vue.use(Unicon, {
  height: 20,
  width: 20
})
